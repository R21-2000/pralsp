...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card">
                    <div class="kartu text-center card-header bg-primary text-white">
                        Tambah menu
                    </div>
                    <div class="card-body">
                        <form method="post" action="">
                            ...
                            <button type="submit" class="btn btn-success btn-block">Udah</button>
                        </form>
                        <a href="admin.php" class="btn btn-danger btn-block mt-3">Gajadi</a>
